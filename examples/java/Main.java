...
public class Main {
    ...
    private static final String MARKET = "IT";
    private static final String EXCHANGE = "EUROTLX";
    private static final String SYMBOL = "EUROTLX:000040";
                ...
                .buildAsync(URI.create(WS_URL), new WebSocket.Listener() {
                    ...
                    public void onOpen(WebSocket webSocket) {
                        String subscribeJson = "{\"action\":\"subscribe\",\"market\":\"" + MARKET
                                + "\",\"exchange\":\"" + EXCHANGE
                                + "\",\"symbols\":[\"EUROTLX:000040\",\"EUROTLX:005930\"],\"replay\":\"last\"}";
