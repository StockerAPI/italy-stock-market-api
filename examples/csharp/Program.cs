...
class Program
{
    ...
    private const string Market = "IT";
    private const string Exchange = "EUROTLX";
    private const string Symbol = "EUROTLX:000040";
    ...
    static async Task StreamRealtime()
    {
        ...
        var subscribe = new
        {
            ...
            market = Market,
            exchange = Exchange,
            symbols = new[] { "EUROTLX:000040", "EUROTLX:005930" },
            replay = "last"
        };
