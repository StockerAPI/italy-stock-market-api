...
Kun Data provides real-time market data for Italy through a token-authenticated API stack designed for charting tools, watchlists, market overview pages, brokerage dashboards, and quant workflows.

This repository focuses on Italy market coverage with support for EUROTLX, MIL.

## API Capabilities

- Real-time WebSocket market data for Italy
...
This repository is designed to make Italy market API coverage easier to discover and evaluate.

## Links

- Website: https://kun.pro/markets/italy-stock-market-api
